...
import fly.play.elasticsearch.filter.{ExistsFilter, RangeExecution, RangeFilter, TermFilter}
import fly.play.elasticsearch.query.{FilteredQuery, TermQuery}
import fly.play.elasticsearch.query.Query.queryToElasticSearchQuery
import fly.play.elasticsearch.filter.MissingFilter
import play.api.libs.json.JsNull
import fly.play.elasticsearch.filter.AndFilter
import fly.play.elasticsearch.filter.OrFilter
import fly.play.elasticsearch.filter.NotFilter
import fly.play.elasticsearch.filter.BoolFilter

object FilterTests extends Specification with ClientUtils {
