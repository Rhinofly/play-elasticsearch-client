 ...
 */
object ElasticSearchQueryTests extends Specification with ClientUtils {
  ...
  "ElasticSearchQuery" should {
    ...
    "accept the query-property 'highlight'" >> {
      ...
      "show highlights in a result" in new WithTestIndexWithMapping {
        ...
        result.hits(0).highlightFor("content") must contain("<em>Rose</em> <em>rose</em> to put <em>rose</em> roes on her rows of roses.")
      }
      ...
      "use tags in highlighted fragments" in new WithTestIndexWithMapping {
        ...
        result.hits.length === 1
        result.hits(0).highlightFor("content") must contain("""<span class="hilite">Rose</span> <span class="hilite">rose</span> to put <span class="hilite">rose</span> roes on her rows of roses.""")
      }
      ...
      "use tags_schema in highlighted fragments" in new WithTestIndexWithMapping {
        ...
        result.hits.length === 1
        result.hits(0).highlightFor("content") must contain("""<em class="hlt1">Rose</em> <em class="hlt1">rose</em> to put <em class="hlt1">rose</em> roes on her rows of roses.""")
      }
